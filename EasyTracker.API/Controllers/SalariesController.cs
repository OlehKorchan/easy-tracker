...
public class SalariesController : ControllerBase
{
    ...
    public async Task<IActionResult> GetUserSalariesAsync()
    {
        ...
        var userSalariesResponse =
            ...
            {
                UserSalaries = _mapper
                    .Map<List<SalaryDTO>, List<SalaryResponseModel>>(
                        salaries)
            };
    ...
    public async Task<IActionResult> PostAsync(SalaryCreateRequestModel salaryCreate)
    {
        ...
        var salaryDto = _mapper.Map<SalaryDTO>(salaryCreate);
        salaryDto.UserName = User.FindFirstValue(ClaimTypes.NameIdentifier);
